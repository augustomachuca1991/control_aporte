                        ...
                        <tr>
                            <td class="header"
                                ...
                                <a href="{{ url('/') }}"
                                    ...
                                    <img src="{{ asset('image/logo-ips-header.png') }}" class="logo"
                                        alt="IPS corrientes - logo"
                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; max-width: 100%; border: none; height: 75px; max-height: 75px; width: 300px;">
                                </a>
                            </td>
                        </tr>
                        <!-- Email Body -->
                                    ...
                                    <tr>
                                        <td class="content-cell"
                                            ...
                                            <p
                                                ...
                                                Ha recibido este mail porque se solicita el cambio de contraseña para su
                                                cuenta para una mayor seguridad.</p>
                                                ...
                                                <tr>
                                                    <td
                                                        ...
                                                        <p
                                                            ...
                                                            contraseña", copie y pegue la URL a continuación en su
                                                            navegador web.
                                                            <span class="break-all"
                                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; word-break: break-all;"><a
                                                                    href="{{ url('/password/reset/' . $token . '?email=' . $email) }}">{{ url('/reset-password/' . $token . '?email=' . $email) }}</a></span>
                                                        </p>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <tr>
                                        <td class="content-cell" align="center"
                                            ...
                                            <p
                                                ...
                                                © 2021 IPS - Instituto de Previsión Social de Corrientes. Todos los
