...
<head>
    ...
    <title>IPS Corrientes | Lockscreen</title>
...
<body class="hold-transition lockscreen">
    ...
    <div class="lockscreen-wrapper">
        <div class="lockscreen-logo">
            <a href="https://adminlte.io/themes/dev/AdminLTE/index2.html"><b>Admin</b>LTE</a>
        </div>
        <!-- User name -->
        ...
        <div class="lockscreen-item">
            ...
            <div class="lockscreen-image">
                <img src="https://adminlte.io/themes/dev/AdminLTE/dist/img/user1-128x128.jpg" alt="User Image">
            </div>
            <!-- /.lockscreen-image -->
