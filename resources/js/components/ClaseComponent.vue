                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <span
                                        ...
                                        v-for="error in errores.cod_clase"
                                    >
                                        <small
                                            ><em>{{ error }}</em></small
                                        >
                            ...
                            <div class="col-sm-9">
                                ...
                                >
                                    <option
                                        ...
                                        :key="categoria.id"
                                        :value="index"
                                        :selected="index === selectedCategoria"
                                    >
                                        {{ categoria.categoria }}
                                    </option>
                                </select>
                                ...
                                <nav aria-label="Contacts Page Navigation">
                                    ...
                                    >
                                        ...
                                        <li
                                            ...
                                            v-for="n in paginate.last_page" :key="n.id"
                                        >
                                            <a
                                                href="#"
                                                class="page-link"
...
export default {
    ...
    methods: {
        ...
        nuevaClase() {
            ...
            formData.append(
                "categoria_id",
                this.categorias[this.selectedCategoria].id
            );
            formData.append("clase", this.descripcion);
            axios
                .post("api/clase/create", formData)
                .then(response => {
                    ...
                    Toast.fire({
                        icon: "success",
                        title:
                            "Se agrego la nueva clase " + response.data.clase,
                        background: "#E7FFD7"
                    });
        ...
        editarClase(index, clase) {
            ...
            this.selectedClase = this.paginate.from + parseInt(index - 1);
        ...
        actualizarClase() {
            ...
            axios
                .put(`api/clase/update/${this.clase.id}`, params)
                .then(response => {
                    Toast.fire({
                        icon: "success",
                        title:
