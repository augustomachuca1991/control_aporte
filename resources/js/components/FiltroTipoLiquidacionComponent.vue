<template>
    ...
    <div v-model="tipoliquidaciones">
        <label for="tipoLiquidacion" class="text-muted"
            ><i class="fas fa-search"></i> Tipo de Liquidacion</label
        >
        <select
            class="custom-select"
            id="tipoLiquidacion"
        ...
        >
            <option class="text-muted" :value="''" selected disabled
                >Seleccione tipo de Liquidacion</option
            >
            <option
                v-for="tipo in tipoliquidaciones"
                :value="tipo.id"
                :tipo="tipo"
