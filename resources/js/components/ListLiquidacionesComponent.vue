            ...
            <tbody>
              ...
              <tr v-for=" liquidacion in filtro.data" :key="liquidacion.id">
                  ...
                  <td>
                      ...
                      <a :href="'#detalle'" class="btn btn-outline-success border-0 rounded-circle btn-xs" data-toggle="modal" v-on:click="show(liquidacion.id)"><i class="fas fa-dollar-sign"></i></a>
                  </td>
              </tr>
            </tbody>
        </table> 
