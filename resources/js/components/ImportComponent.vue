                                ...
                                >
                                    ...
                                    <tbody>
                                        ...
                                        >
                                            ...
                                            <td>
                                                {{
                                                    reciente.created_at | moment
                                                }}
                                            </td>
                                            <td>
                                                <span
                                                    v-if="reciente.status"
                                                    class="badge bg-info"
                                                    >Activo</span
                                                >
                                                <span
                          ...
                          <i class="fas fa-search"></i>
                            ...
                            <div class="card-body table-responsive p-0">
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                        <tr
                                            v-for="declaracion_jurada in declaraciones_juradas"
                                        ...
                                        >
                                            ...
                                            <td>
                                                <button
                                                    :id="declaracion_jurada.id"
                                                    v-if="
                                                        declaracion_jurada.status
                                                    "
                                                    class="btn btn-outline-warning rounded btn-xs"
                                                    @click="
                                                        aplicar(
                                                            declaracion_jurada
                                                        )
