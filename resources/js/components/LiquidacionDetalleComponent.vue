            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">
                        Periodo - {{ liquidacionDetalle.periodo.periodo }}
                    </h5>
                    <button
                        type="button"
                        class="close"
                ...
                <div class="modal-body">
                    ...
                    <div class="row bg-light">
                        ...
                        <div class="col">
                            ...
                            <div class="row">
                                <div class="col">
                                    <small>{{
                                        liquidacionDetalle.organismo.organismo
                                    }}</small>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <small
                                        >{{
                                            liquidacionDetalle.liquidacion
                                                .historia_laborales[0].puesto.id
                                        }}
                                        cargo</small
                                    >
                                </div>
                        ...
                        <div class="col">
                            ...
                            <div class="row">
                                <div class="col">
                                    <small>{{
                                        liquidacionDetalle.periodo.mes
                                    }}</small>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            ...
                            <div class="row">
                                <div class="col">
                                    <small>{{
                                        liquidacionDetalle.periodo.anio
                                    }}</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            ...
                            <div class="row">
                                <div class="col">
                                    <small>{{
                                        liquidacionDetalle.liquidacion
                                            .historia_laborales[0].puesto.agente
                                            .cuil
                                    }}</small>
                                </div>
                            </div>
                                    ...
                                    <small>
                                        {{
                                            liquidacionDetalle.liquidacion
                                                ...
                                                .historialiquidaciones[0].estado
                                                .estado
                                        }}
                                    </small>
                                </div>
                    ...
                    >
                        ...
                        >
                            ...
                            <tbody>
                                <tr
                                    v-for="detalle in liquidacionDetalle.liquidacion.detalles"
                                    :key="detalle.id"
                                >
                                    <th scope="row">
                            ...
                            <tfoot class="bg-light">
                                ...
                                <td>
                                    <small v-if="liquidacionDetalle.liquidacion.no_remunerativo"
                                        >$
                                        {{
                                            parseInt(liquidacionDetalle.liquidacion.bruto) -
                                                parseInt(
                                                    liquidacionDetalle.liquidacion.no_remunerativo
                                                )
                                        }}</small
                                    >
                                    <small v-else
                                        >$
                                        {{ parseInt(liquidacionDetalle.liquidacion.bruto) }}</small
                                    >
                                </td>
                                <td>
                                    <small
                                        >$
                                        {{ liquidacionDetalle.liquidacion.no_remunerativo }}</small
                                    >
                                </td>
                                <td>
                                    <small
                                        ...
                                        {{
                                            parseInt(liquidacionDetalle.liquidacion.familiar) +
                                                parseInt(liquidacionDetalle.liquidacion.hijo) +
                                                parseInt(liquidacionDetalle.liquidacion.esposa)
                                        }}</small
                                    >
                                </td>
                                <td>
                                    <small>$ {{ liquidacionDetalle.liquidacion.descuento }}</small>
                                </td>
                            </tfoot>
                        </table>
                    </div>
...
<script>
export default {
    props: ["index", "liquidacionDetalle"],
    data: function() {
        return {
            liquidaciones: []
        };
